<template>
    <transition name = "route" mode = "out-in" appear>
        <section>
            <h3 class = "mb-5">Slides
                <router-link to = "/panel/new/slide" class = "text-dark">
                    <span title = "add new slide" class = "px-3 d-inline-block align-middle"><i class = "bi bi-plus-circle-fill p-0 mt-2 m-0" style = "font-size: 15px"></i></span>
                </router-link>
                <p style = "font-size: 14px">to change the priotirt of the slides, please drag & drop.</p>
            </h3>
            ...
            <div class = "row mt-3">
                <div class = "col-12 mb-3">
                    ...
                    <div v-else><p class = "fw-bold">no slides</p></div>
