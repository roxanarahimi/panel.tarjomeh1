                ...
                <ul class="nav nav-pills flex-column mb-auto " style="padding-top: 2px">
                    ...
                    <li class="nav-item" id="">
                        <router-link to="/panel" class="nav-link text-white"
                            ...
                            <i title="dashboard" class="bi bi-speedometer2 me-2"></i>
                    ...
                    <li>
                        <router-link to="/panel/orders" class="nav-link text-white"
                            ...
                            <i title="orders" class="bi bi-box2-heart-fill me-2"></i>
                        </router-link>
                    </li>
                    <li>
                        <router-link to="/panel/languages" class="nav-link text-white"
                                     :class="{active: $route.fullPath ==='/panel/languages'}">
                            <span class="sidebar_title">languages</span>
                            <i title="languages" class="bi bi-type me-2"></i>
                        </router-link>
                    </li>
                    <li>
                        <router-link to="/panel/translate/languages" class="nav-link text-white"
                                     :class="{active: $route.fullPath ==='/panel/translate/languages'}">
                            <span class="sidebar_title">translations</span>
                            <i title="translations" class="bi bi-translate me-2"></i>
                    ...
                    <li>
                        <router-link to="/panel/slides" class="nav-link text-white"
                            ...
                            <span class="sidebar_title">slides</span>
                            <i title="slides" class="bi bi-collection-fill me-2"></i>
                        </router-link>
                    </li>
                    <li>
                        <router-link to="/panel/resumes" class="nav-link text-white"
                                     :class="{active: $route.fullPath ==='/panel/resumes'}">
                            <span class="sidebar_title">resumes</span>
                            <i title="resumes" class="bi bi-person-lines-fill me-2"></i>
                        </router-link>
                    </li>
                    <li>
                        <router-link to="/panel/users" class="nav-link text-white"
                                     :class="{active: $route.fullPath ==='/panel/users'}">
                            <span class="sidebar_title">users</span>
                            <i title="users" class="bi bi-people-fill me-2"></i>
                        </router-link>
                    </li>
                    <li>
                        <router-link to="/panel/finance" class="nav-link text-white"
                                     :class="{active: $route.fullPath ==='/panel/finance'}">
                            <span class="sidebar_title">finance</span>
                            <i title="finance" class="bi bi-currency-exchange me-2"></i>
                        </router-link>
                    </li>
                    <!--                    <li>-->
                    ...
                    <li>
                        <router-link to="/panel/admins" class="nav-link text-white"
                            ...
                            <span class="sidebar_title">admins</span>
                            <i title="admins" class="bi bi-person-circle me-2"></i>
                        </router-link>
                    </li>
                        ...
                        <ul class="navbar-nav ">
                            <li class="nav-item dropdown ">
                                ...
                                <ul class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
                                    <li>
                                        <router-link class="dropdown-item" to="/panel/profile">profile</router-link>
                                    </li>
                                    <li><a class="dropdown-item" @click="logout" href="#">exit</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
